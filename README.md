...
| --- | --- |
| [enterprise-agentic-rag-azure](https://github.com/Krishna89287/enterprise-agentic-rag-azure) | Production agentic RAG with LangGraph, guardrails, evals and observability |
| [ai-ops-incident-agent](https://github.com/Krishna89287/ai-ops-incident-agent) | Triages incidents, suggests root cause, drafts change tickets for human review |
| [rag-support-assistant](https://github.com/Krishna89287/rag-support-assistant) | RAG support assistant with citations, guardrails, automated evaluation and KPIs |
| [graphrag-knowledge-assistant](https://github.com/Krishna89287/graphrag-knowledge-assistant) | Multi-hop RAG over a knowledge graph |
| [llm-observability-platform](https://github.com/Krishna89287/llm-observability-platform) | Tracks LLM cost, latency, tokens and answer faithfulness |
| [cloud-native-platform-aws](https://github.com/Krishna89287/cloud-native-platform-aws) | Internal developer platform: Terraform EKS, ArgoCD GitOps, Prometheus, SLOs |
